{ pkgs, ... }: {
  programs.bash = {
    ...
    shellAliases = {
      ...
      hmcheck = "nix run github:nix-community/home-manager/release-25.11 -- build --flake /etc/nixos#louis@nixos";
      hmrebuild = "nix run github:nix-community/home-manager/release-25.11 -- switch --flake /etc/nixos#louis@nixos";
      g      = "git";
      gs     = "git status";
      gd     = "git diff";
